...
project = project
  .replaceAll('CURRENT_PROJECT_VERSION = 154;', 'CURRENT_PROJECT_VERSION = 157;')
  .replaceAll('CURRENT_PROJECT_VERSION = 155;', 'CURRENT_PROJECT_VERSION = 157;')
  .replaceAll('CURRENT_PROJECT_VERSION = 156;', 'CURRENT_PROJECT_VERSION = 157;')
...
if (buildNumbers.length !== 2 || buildNumbers.some((value) => value !== 157)) {
  throw new Error(`SafarMate 1.1 requires iOS build 157; found ${buildNumbers.join(', ')}.`);
}
...
console.log('Configured SafarMate iOS 1.1.0 (157) with WeatherKit entitlement.');
