...
if (versions.length < 2 || versions.some((version) => !Number.isInteger(version) || version < 101) || new Set(versions).size !== 1) {
  console.error('iOS build numbers must match and must be at least 101.', versions);
  process.exit(1);
}
