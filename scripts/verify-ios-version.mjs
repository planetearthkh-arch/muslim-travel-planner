...
if (versions.length < 2 || versions.some((version) => !Number.isInteger(version) || version < 102) || new Set(versions).size !== 1) {
  console.error('iOS build numbers must match and must be at least 102.', versions);
  process.exit(1);
}
