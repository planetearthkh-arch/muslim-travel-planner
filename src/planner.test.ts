...
test('SafarMate branding, metadata, manifest, and launch pages are truthful', async () => {
  ...
  assert.equal(privacy.includes('Last updated: July 12, 2026'), true);
  ...
  assert.equal(privacy.includes('Son güncelleme: 12 Temmuz 2026'), true);
...
test('iOS app icon asset catalog references generated opaque master-derived files', async () => {
  ...
  assert.equal(verifyScript.includes('resources/safarmate-app-icon-1024.png'), true);
